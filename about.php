		...
		<div class="container">
			...
			<div class="text-center">
				<div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
					<img src="images/services/1.jpg" alt="" style="width:200px;height:200px;">
					<h4>Milan Lamaina</h4>
					<p>Security specialist</p>
				</div>
				<div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
					<img src="images/services/2.jpg" alt="" style="width:200px;height:200px;">
					<h4>Jelte van der heide</h4>
					<p>System analyst </p>
				</div>
				<div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms">
					<img src="images/services/3.jpg" alt="" style="width:200px;height:200px;" >
					<h4>Roobin hofman</h4>
					<p>Support Services Specialist</p>
				</div>
			</div>
		</div>
	</div>
